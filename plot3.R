...
pngName <- "plot3.png"
powerSelect <- c("Date", "Time", "Sub_metering_1", "Sub_metering_2", "Sub_metering_3")
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty=c(rep("solid", 3)))
